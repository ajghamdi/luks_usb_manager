...
#define FILESYSTEM_UUID "abcdef01-2345-6789-0a1b-2c3d4e5f6a7b"  // UUID of the filesystem inside LUKS
#define LUKS_DEVICE_UUID "ffffffff-5555-0000-11aa-0123456789fe" // UUID of the LUKS partition
